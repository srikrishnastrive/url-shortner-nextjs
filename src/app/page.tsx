    ...
    <>
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600">
        <div className="p-10 bg-white rounded-lg shadow-2xl max-w-lg">
          <h1 className="text-2xl font-bold mb-6 text-center text-gray-700">URL SHORTY</h1>
        ...
        <div className="mt-6 text-center">
          <Link href="/urls">
            ...
            <span className="btn btn-secondary w-full text-black"> View All Shortened URLS </span>
          </Link>
        </div>
